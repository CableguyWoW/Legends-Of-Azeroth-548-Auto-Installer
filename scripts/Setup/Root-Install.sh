...
((NUM++)); echo "- [$NUM] : Install Skyfire Requirements"
...
sudo apt-get update -y && sudo apt-get install -y \
    build-essential autoconf libtool gcc g++ make cmake subversion git-core \
    git patch wget links zip unzip openssl libssl-dev zlib1g-dev libbz2-dev \
    libreadline-dev lsb-release libncurses5-dev libboost-all-dev
fi
