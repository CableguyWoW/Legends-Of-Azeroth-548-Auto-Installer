...
echo "alias updateinstaller=\"cd / && cd Legends-Of-Azeroth-548-Auto-Installer && cp -rf configs / && rm -rf Legends-Of-Azeroth-548-Auto-Installer && apt-get install git sudo -y && cd / && git clone https://github.com/CableguyWoW/Legends-Of-Azeroth-548-Auto-Installer/ /Legends-Of-Azeroth-548-Auto-Installer && cd Legends-Of-Azeroth-548-Auto-Installer && cp -rf /configs /Legends-Of-Azeroth-548-Auto-Installer && chmod +x Init.sh && ./Init.sh all\"" >> ~/.bashrc
